...
gp = {}
gp['camadaMaxima'] = 10
auth_server_url = 'http://10.11.82.76:3890/auth'  # URL do servidor de autentica��o
...
@app.route('/')
def index():
    return render_template('index.html')  # Renderiza a p�gina de autentica��o
...
def authenticate():
    ...
    if response.status_code == 200:
        return redirect(url_for('rede'))  # Autentica��o bem-sucedida, redireciona para a rota '/rede'
    else:
