    ...
    def getPageGoogle(self, page=1, segundos_delay=2.0):
        ...
        for item in self.result:
            ...
            try:
                ...
                blocoImgs = bloco.find_all('img')
                imagemId = ''
                for blocoImg in blocoImgs:
                    imagemId = blocoImg.get('id')
                    if imagemId:
                        break
            ...
            imagem = dicImagens.get(imagemId, '')
...
async def json_google_chaves(termos, pagina=1, n_palavras_chave=20):
    gs = googleSearch()
    #print(termos, pagina, n_palavras_chave)
    gs.search(termos, pagina, n_palavras_chave)
